...
public class ShapeDrawableView extends View {
    ...
    private Integer[] color = {Color.BLACK, Color.BLUE, Color.GREEN, Color.RED};
    ...
    private ShapeDrawable makeShapeDrawable(int x, int y){
        ...
        int height = RandomUtils.randomInt(maxHeigth)+5;
        shapeD.setBounds(x-width/2, y-height/2,x+width/2, y+height/2);
        shapeD.getPaint().setColor(RandomUtils.randomElement(color));
        return (shapeD);
    }
